...
TEST(Crupier, ConstructorParametros) {
  Crupier c("44XX", "2", "Carlos", "Gutierrez",30, "C/ Mesa 1", "Aguilar", "Sevilla", "España");
...
TEST(Crupier, ConstructorCopiaDefecto) {
  Crupier p("55XX", "3", "Carlos", "Gutierrez",30, "C/ Mesa 1", "Aguilar", "Sevilla", "España");
  Crupier q(p);
...
TEST(Crupier, OperadorIgual) {
  Crupier p("66XX", "4", "Carlos", "Gutierrez", 30,"C/ Mesa 1", "Aguilar", "Sevilla", "España");
  Crupier q("77FF", "5");
  q=p;
