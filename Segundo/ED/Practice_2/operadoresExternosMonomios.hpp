...
namespace ed
{
	...
	*/ 
	...
	/*!
		...
		\param numero_real: número de tipo double que se compara con el monomio
	...
	*/
	...
	/*!
		...
		\note Función sobrecargada
		\param numero_real: número de tipo double que invoca el operador al compararse con el monomio
	...
	*/
	...
	/*!
		\brief Operador * entre un número real a la derecha y un monomio a la izquierda
		\param numero_real: número que multiplica al coeficiente del monomio
	...
	*/
	...
	/*!
		\brief Operador * entre un número real a la izquierda y un monomio a la derecha
		\param numero_real: número que multiplica al coeficiente del monomio
		\param monomio: Referencia constante al monomio pasado como argumento
		\return Monomio resultante de la operacion
	*/
	...
	*/
	...
	/*!
		\brief Operador / entre un número real a la derecha y un monomio a la izquierda
		\param numero_real: número que divide al coeficiente del monomio
		\param monomio: Referencia constante al monomio pasado como argumento
		\return Monomio resultante de la operacion
	*/
	Monomio & operator/(double numero_real, Monomio const &monomio);
